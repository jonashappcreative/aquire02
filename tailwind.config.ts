  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        chain: {
          sackson: "hsl(var(--chain-sackson))",
          tower: "hsl(var(--chain-tower))",
          worldwide: "hsl(var(--chain-worldwide))",
          american: "hsl(var(--chain-american))",
